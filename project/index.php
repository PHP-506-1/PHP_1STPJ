<?php
//수 DOC_ROOT와 URL_DB를 정의하고, URL_DB를 이용하여 db_conn.php를 include
...
// 해당 페이지에 보여줄 데이터 구하기
$current_page_no = isset($_GET['page']) ? (int)$_GET['page'] : 1; //현재 페이지 번호를 $_GET['page']에서 받아옴
